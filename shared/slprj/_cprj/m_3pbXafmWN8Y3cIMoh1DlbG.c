...
#include "m_3pbXafmWN8Y3cIMoh1DlbG.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  codertarget_arduinobase_internal_arduinoBLEReceive *obj);
static void mw__internal__call__reset(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance, const emlrtStack *sp, real_T SampleTime);
static void mw__internal__call__step(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance, const emlrtStack *sp, real_T SampleTime, int8_T c_y0[4],
  uint8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
...
static void init_simulink_io_address(InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG
  *moduleInstance);
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->b_y0 = (int8_T (*)[4])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S, int_T tid)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S, int_T tid)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
  InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *moduleInstance =
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG *)calloc(1, sizeof
    (InstanceStruct_3pbXafmWN8Y3cIMoh1DlbG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_3pbXafmWN8Y3cIMoh1DlbG);
  ssSetmdlInitializeConditions(S, mdlInitialize_3pbXafmWN8Y3cIMoh1DlbG);
  ssSetmdlUpdate(S, mdlUpdate_3pbXafmWN8Y3cIMoh1DlbG);
  ssSetmdlTerminate(S, mdlTerminate_3pbXafmWN8Y3cIMoh1DlbG);
  ssSetmdlEnable(S, mdlEnable_3pbXafmWN8Y3cIMoh1DlbG);
  ssSetmdlDisable(S, mdlDisable_3pbXafmWN8Y3cIMoh1DlbG);
...
static void mdlProcessParameters_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S)
{
}

void method_dispatcher_3pbXafmWN8Y3cIMoh1DlbG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_3pbXafmWN8Y3cIMoh1DlbG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_3pbXafmWN8Y3cIMoh1DlbG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_3pbXafmWN8Y3cIMoh1DlbG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_3pbXafmWN8Y3cIMoh1DlbG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 3pbXafmWN8Y3cIMoh1DlbG.\n"
...
mxArray *cgxe_3pbXafmWN8Y3cIMoh1DlbG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_3pbXafmWN8Y3cIMoh1DlbG_fallback_info(void)
{
